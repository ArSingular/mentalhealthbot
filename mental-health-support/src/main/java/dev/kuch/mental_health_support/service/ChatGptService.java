...
public class ChatGptService {
    ...
    public ChatGptService(ChatSessionService sessionService) {
    ...
    public String askChatGpt(String chatId, String userMessage) {
        ...
        try {
            ...
            _Якщо хочеш попрацювати з фахівцем — можеш написати мені в_ [Instagram](https://www.instagram.com/cozy_psychology._?igsh=MXZ1NWZ4eG1xZnJ2Mw==) 💬
...
//            headers.set("X-Title", "Mental Health Bot");
            ...
            if (response.getStatusCode() != HttpStatus.OK) {
                return "На жаль, виникла помилка при отриманні відповіді. Спробуй ще раз.";
            }


            String responseBody = response.getBody();
            if (responseBody == null || !responseBody.trim().startsWith("{")) {
                return "Отримана некоректна відповідь від сервера. Спробуй ще раз.";
            }
...
//                        .trim();
            ...
            if (json.has("message")) {
                ...
                return "На жаль, відповідь від сервера не містить очікуваних даних. Спробуй ще раз.";
            }
        } catch (Exception e) {
            e.printStackTrace();
            return "На жаль, сталася помилка: " + e.getMessage();
        }
    }
